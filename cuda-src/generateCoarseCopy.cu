...
void GenerateCoarseProblemInside(const SparseMatrix &Af) {
...
void CopyCoarseProblemToHostInside(SparseMatrix &A) {
  ...
  CUDA_CHECK_COMMAND(cudaMemcpy(A.mgData->d_f2cOperator, A.mgData->f2cOperator,
