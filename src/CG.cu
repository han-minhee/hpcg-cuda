 ...
 #define TICK()  cudaDeviceSynchronize(); t0 = mytimer() //!< record current time in 't0'
 #define TOCK(t) cudaDeviceSynchronize(); t += mytimer() - t0 //!< store time difference in 't' using time in 't0'
